...
<div id="header-wrapper">
	<?php if ($logo): ?> 
		<div id="logo-wrapper">
			<div class="logo">
				<a href="<?php print $base_path ?>" title="<?php print t('Home') ?>"><img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/brackenswan.png';?>" alt="<?php print t('Home') ?>" /></a>
			</div>
...
<div class="slideshow">
<img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/banners/banner_01_friendship.png';?>" width="950" height="270" alt="slideshow 1"/>
<img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/banners/banner_02_passion.png';?>" width="950" height="270" alt="slideshow 2"/>
<img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/banners/banner_03_grace.png';?>" width="950" height="270" alt="slideshow 3"/>
<img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/banners/banner_04_precision.png';?>" width="950" height="270" alt="slideshow 4"/>
<img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/banners/banner_05_artistry.png';?>" width="950" height="270" alt="slideshow 5"/>
<img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/banners/banner_06_performance.png';?>" width="950" height="270" alt="slideshow 6"/>
<img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/banners/banner_07_accomplishment.png';?>" width="950" height="270" alt="slideshow 7"/>
<img src="<?php echo base_path() . drupal_get_path('module', 'bracken') . '/images/banners/banner_08_brackenschool.png';?>" width="950" height="270" alt="slideshow 8"/>
</div>
</div>
</div>
<?php endif; ?>
